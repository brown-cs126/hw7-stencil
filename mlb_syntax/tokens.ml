...
let get_token s index =
  if Str.string_match whitespace_regex s index then (None, Str.match_end ())
  else if Str.string_match function_regex s index then
    (Some FUNCTION, Str.match_end ())
  else if Str.string_match let_regex s index then (Some LET, Str.match_end ())
  else if Str.string_match in_regex s index then (Some IN, Str.match_end ())
